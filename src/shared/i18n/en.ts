const en = {
  ...
  home: {
    title: 'Paste a YouTube link and see the key points before you watch. <0>Free</0>',
    ...
    featuredDetailHint: 'Open the full result page to inspect the complete analysis, takeaways, and transcript.',
  ...
  report: {
    ...
    subtitle: 'Overview of platform metrics and trends.',
    periodLabel: 'Period',
    period7d: '7 days',
    period30d: '30 days',
    period90d: '90 days',
    ...
    statUsersSub: 'Total registered',
    statVideosSub: 'Total analyzed',
    statAnalysesSub: 'Total generated',
    statEngagementSub: 'Total events',
    ...
    topChannelsSubtitle: 'Most analyzed YouTube channels.',
    topKeywordsTitle: 'Top Keywords',
    topKeywordsSubtitle: 'Most frequent keywords from analyses.',
    passwordTitle: 'Enter password to access the report.',
    passwordLabel: 'Password',
    passwordSubmit: 'Access Report',
